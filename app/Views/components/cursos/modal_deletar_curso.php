<div class="modal fade" id="modal-deletar-curso" tabindex="-1" role="dialog" aria-labelledby="modal-deletar-curso-label" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="form-deletar-curso" class="forms-sample" method="post" action="<?php echo base_url("sys/cursos/deletar"); ?>">
                <?php echo csrf_field() ?>
                <input type="hidden" id="deletar-id" name="id" />
                <div class="modal-body text-break">Confirma a exclusão do curso <strong id="deletar-nome"></strong>?</div>
