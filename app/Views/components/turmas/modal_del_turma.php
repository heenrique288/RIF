<div class="modal fade" id="turmaModalDeletar" tabindex="-1" aria-labelledby="turmaModalDeletarLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="turmaModalDeletarLabel">Confirmação de Exclusão</h5>
